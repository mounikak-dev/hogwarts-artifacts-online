...
public class ExceptionHandlerAdvice {
    ...
    Result handleValidationException(MethodArgumentNotValidException ex) {
        ...
        return new Result(false, StatusCode.INVALID_ARGUMENT, "Arguments invalid, see data for details.", map);
    }
    ...
    Result handleInsufficientAuthenticationException(InsufficientAuthenticationException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "login credentials missing", ex.getMessage());
    }
    ...
    Result handleInvalidBearerTokenException(InvalidBearerTokenException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "Access token provided is expired, revoked or invalid.", ex.getMessage());
    }
